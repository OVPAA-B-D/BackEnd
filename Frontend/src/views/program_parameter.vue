<template>
  ...
  <div class="flex font-roboto pt-16 min-h-screen">
        ...
        <div class="pb-3">
          ...
          <span
            class="
              flex
              justify-start
              text-xs text-yellow-150
              items-center
              gap-x-1
            "
          >
            <img src="/icons/icon16_man.svg" />
            <h1>Johann Abad</h1>
          </span>
          <span
            class="
            ...
            "
          >
            <img src="/icons/icon17_contact.svg" />
            <h1>0902105050</h1>
          </span>
          <span
            class="
            ...
            "
          >
            <img src="/icons/icon18_inbox.svg" />
            <h1>johann@gmail.com</h1>
          </span>
          <h1></h1>
        </div>
        <div
      ...
      <div class="flex flex-col h-full pt-10 px-4 space-y-3">
        <div class="flex justify-between items-center">
          <div class="flex space-x-2">
            <button
              @click="show_add_parameter = !show_add_parameter"
              class="
                text-blue-150
                space-x-2
              ...
              "
            >
              <p class="material-icons text-sm">add_circle_outline</p>
              <p class="text-sm">Add Parameter</p>
            </button>
          </div>
          <div
            class="
        ...
        <div class="flex flex-row h-99 w-fullrounded-xl p-1">
          ...
          >
            ...
            >
              <div class="w-full">
                ...
                >
                  ...
                  <div
                    class="
                      ...
                      justify-start
                      gap-x-2
                      text-blue-150 text-lg
                    "
                  >
                    <router-link to="/home_admin">
                      <a class="hover:underline cursor-pointer"
                        >Infomation Technology</a
                      ></router-link
                    >>
                    <router-link to="/program_level"
                      ><a class="hover:underline">Level 1</a></router-link
                    >>
                ...
                <div class="items-start w-full flex-col flex flex-wrap pl-7">
                  <div class="w-full">
                    <div
                      class="flex flex-shrink items-center p-2 justify-between"
                    >
                      <span class="flex items-baseline gap-x-3">
                        <h1
                          id="parameterLabel"
                          class="text-2xl text-blue-150 font-bold"
                        >
                          Parameter A
                        </h1>
                        <input
                        ...
                        />
                        <img
                          @click="show_input('parameterLabel', 'parameterName')"
                          src="/icons/icon19_rename_orange.svg"
                        ...
                        <img
                          ...
                          "
                          src="/icons/icon11_delete_red.svg"
                          class="cursor-pointer"
                        />
                        <h1 class="text-green-150">Completed</h1>
                      </span>
                      <button
                        @click="show_add_benchmark = !show_add_benchmark"
                        class="
                          border-2
                          flex
                          px-2
                      ...
                      >
                        ...
                        <h1 class="text-blue-150">Add Bechmark</h1>
                      </button>
                    </div>
                    <div class="mr-4">
                      <div
                      ...
                      >
                        <span class="flex items-baseline">
                          <h1 id="bench1" class="text-xl text-yellow-150">
                            Benchmark A1
                          </h1>
                          <input
                            type="text"
                          ...
                          />
                          <img
                            src="/icons/icon19yellow.svg"
                            class="cursor-pointer"
                            @click="show_input('bench1', 'bench1_input')"
                          />
                        </span>
                        <div class="flex space-x-3 mb-0.5">
                          ...
                          >
                            <img
                              src="/icons/icon10_open_file.svg"
                              class="w-5 h-5"
                            />
                            open file
                          </button>
                          <button
                            @click="show_add_edit_row = !show_add_edit_row"
                            class="
                              text-white
                              flex
                              items-center
                ...
                <div class="items-start w-full flex-col flex flex-wrap pl-7">
                  <div class="w-full">
                    <div class="flex items-center p-2 justify-between">
                      <span class="flex items-baseline gap-x-3">
                        <h1 class="text-2xl text-blue-150 font-bold">
                          Parameter B
                        </h1>
                    ...
                    <div class="mr-4">
                      ...
                      >
                        ...
                        <div class="flex space-x-3 mb-0.5">
                          ...
                          >
                            <img
                              src="/icons/icon_empty_folder.svg"
                              class="w-5 h-5"
                            />
                            open file
                          </button>
            ...
            <div
              v-if="show_details"
              class="flex w-1/3 h-full rounded-xl bg-white"
            >
              <div
                class="
                  h-full
              ...
              >
                ...
                >
                  <div class="flex justify-between items-center p-4">
                    <h1 class="font-bold text-yellow-150">Parameter</h1>
                    <img
                      src="icons/icon_close_x.svg"
                      class="cursor-pointer"
                      @click="show_details = !show_details"
                    />
                  </div>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <h1 class="text-xl text-blue-150 font-bold">
                          Comments
                        </h1>
                      </div>
                    </div>
    ...
    >
      <div
        class="w-97 flex flex-col bg-white p-5 gap-y-3 shadow-3xl rounded-3xl"
      >
        <div class="flex justify-between items-center">
          <h1 class="font-bold text-lg text-yellow-150">Add Parameter</h1>
          <button
            @click="show_add_parameter = !show_add_parameter"
            class="text-red-150 text-lg"
          >
            CLOSE
          </button>
        </div>
      ...
      >
        ...
        <div class="flex flex-col gap-y-3 justify-start items-center">
          <div class="w-full">
            <h1 class="text-blue-150">Label</h1>
            <input
              placeholder="Description of  new benchmark"
              type="text"
              class="
                placeholder-blue-150
                border-2
        ...
        <div class="flex flex-col gap-y-3 justify-start items-center">
          <div class="flex h-full overflow-auto w-full items-center gap-x-2">
            <draggable
              ...
              @end="drag = false"
              item-key="id"
              class="w-full flex flex-col justify-center gap-y-1"
            >
    ...
    >
      <div
        ...
        "
      >
        <h1 class="text-blue-150 text-xl">
