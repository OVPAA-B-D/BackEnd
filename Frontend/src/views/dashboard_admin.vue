  ...
  <div class="flex font-roboto -z-1 pt-16 min-h-screen">
    ...
    >
      ...
      <div class="flex flex-col items-center" v-for="personal in personalInfo">
        <h1 class="uppercase text-white text-lg font-bold">
    ...
    <div class="flex flex-col gap-y-5 pt-7 px-10 pb-10 w-full">
      <div class="flex w-full gap-2 flex-wrap justify-between">
        ...
        >
          <div
            class="w-full relative flex flex-col rounded-lg h-full p-5 bg-white"
          >
            ...
            <span class="absolute flex-wrap w-52 bottom-5">
              <h1 class="text-2xl text-yellow-150">90% out of 100% are done</h1>
            </span>
