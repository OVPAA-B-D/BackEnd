...
<script>
// @ is an alias to /src
// import pdfFile from "./Project-Timeline.pdf"
...
export default { 
  ...
  data(){
    return{
      // name: 'Project-Timeline.pdf', //change which pdf file loads
      // path: '.../node_modules/caniuse-lite/data/features/pdf-viewer.js', //path of the PDF.js viewer.html
        activeBtn:0,
        bg_button:0,
          folder_details:[
          {
