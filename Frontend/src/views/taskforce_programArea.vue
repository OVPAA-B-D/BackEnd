               ...
               <div class=" flex sticky w-max top-0 mt-4 space-x-2 items-center">
                ...
                <div class=" items-start flex-row  flex flex-wrap relative pl-7 " >
                 ...
                 <div @dblclick="routing('/admin_program_performance_profile')"
                  ...
                  <div @click="isActive_function(folderx.id),btn_enable='on',index_array(folderx.id),getAreaComments(folderx.areaID),
                  folder_id=folderx.id,folder_name=folderx.id+'x',rename_folder,detailing()" :class="{outline: bg_btn === folderx.id }" class=" flex flex-col  justify-center w-28  mt-10 hover:bg-gray-200 mr-2 border-yellow-150 cursor-pointer">
                <div @dblclick="routing('/program_parameter_taskforce'),perform()"  class="w-full p-2 flex justify-center">
