<template>
  ...
  <div class=" bg-white shadow-3xl flex flex-col  h-min w-full p-2 rounded-xl">
      <div class="flex justify-between">
          ...
          <h1 class="text-blue-150 text-sm font-bold">Admin 1</h1>
  ...
  <div class=" bg-white shadow-3xl flex flex-col  h-min w-full p-2 rounded-xl">
      <div class="flex justify-between">
          ...
          <div class="flex flex-col">
          <h1 class="text-blue-150 text-sm font-bold">Mr.Bean</h1>
          <h1 class="text-yellow-150 text-xs">Internal Accreditor</h1>
          </div>
      </div>
      <div class="flex items-end flex-col text-xs text-gray-150">
  ...
  <div class=" bg-white shadow-3xl flex flex-col  h-min w-full p-2 rounded-xl">
      <div class="flex justify-between">
          ...
          <div class="flex flex-col">
          <h1 class="text-blue-150 text-sm font-bold">Dr. Sheldon Copper</h1>
          <h1 class="text-yellow-150 text-xs">Internal Accreditor</h1>
          </div>
      </div>
      <div class="flex items-end flex-col text-xs text-gray-150">
