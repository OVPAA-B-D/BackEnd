      ...
      <div class="flex-col h-full pt-10 px-4 space-y-3">
        <div class="flex justify-between items-center">
          <div class="flex space-x-2">
            ...
            <button
              ...
              "
            >
              <p class="material-icons text-sm">border_color</p>
            ...
            <button
              ...
              "
            >
              <p class="material-icons text-sm">delete</p>
              <p class="text-sm">Delete</p>
            </button>
            <button
              v-else-if="btn_enable == 'off'"
              class="
                bg-gray-150
                space-x-2
                flex
            ...
            <button
              @click="show_add_accre = !show_add_accre"
              class="
                text-blue-150
                space-x-2
            ...
            >
              ...
              <p class="text-sm">Add Accreditor</p>
            </button>
          </div>
          <div
            class="
        ...
        <div class="flex flex-row h-99 rounded-xl bg-white p-1">
          ...
          >
            ...
            >
              <button
                @click="(btn_enable = 'off'), show_default()"
                :class="{ outline: bg_btn === 0 }"
                class="absolute border-none w-full h-full inset-0"
              ></button>

              <div class="flex sticky w-max top-0 mt-4 space-x-2 items-center">
                <router-link to="/home_taskforce">
                  <div class="cursor-pointer w-4-h-4">
                    <img src="/icons/icon1_arrow_back.svg" /></div
                ></router-link>
                ...
                >
                  ...
                  >
                    <router-link :to="linkto">
                      <div
                        @dblclick="linkto = '/program_parameter_taskforce'"
                        @click="
                          (btn_enable = 'on'),
            ...
            >
              ...
              >
                <div class="flex justify-between items-center p-4">
                  <h1 class="font-bold text-yellow-150">folder name</h1>
                  <img
