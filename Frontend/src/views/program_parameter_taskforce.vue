          ...
          >
            ...
            >
              <div class="w-full">
                ...
                <div
                  v-for="parameter_row in Parameter"
                  :key="parameter_row.id"
                  class="items-start w-full flex-col flex flex-wrap pl-7"
                >
                  <div class="w-full">
                    <div
                          ...
                          <div class="mr-4">
                            ...
                            >
                              <span class="flex items-baseline">
                                <h1 class="text-xl text-yellow-150">
                                  {{ benchmark_row.benchmarkLabel }}
                                </h1>
                              </span>
